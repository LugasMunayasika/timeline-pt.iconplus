                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <?php if(!empty($announce)): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                            <form method="post" action="<?php echo base_url() ?>anggota_proyek/submit" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="fullname" class="form-control col-md-3 col-sm-3 col-xs-12">
