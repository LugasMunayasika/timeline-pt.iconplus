<div class="">
    ...
    <div class="row top_tiles">
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <div class="tile-stats">
                ...
                <h3>Divisi</h3>
                <p>Jumlah general manager terdaftar</p>
            </div>
        </div>
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <div class="tile-stats">
                ...
                <h3>Project</h3>
                <p>Jumlah supervisor terdaftar</p>
            </div>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-list"></i>  Data Timeline ICON+</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <label>Nama Timeline ICON+</label>
                    <p>&emsp;&nbsp;
